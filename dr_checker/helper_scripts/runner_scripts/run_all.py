...
def setup_args():
    ...
    parser.add_argument('-a', action='store', dest='chipset_num',
                        help='Chipset number. Valid chipset numbers are: 1(mediatek)|2(qualcomm)|3(huawei)|4(samsung)|5(ucore_plus)',
                        type=int)
    # chipset number
...
def main():
    ...
    arg_dict['chipset_num'] = parsed_args.chipset_num           # chipset_num
    arg_dict['makeout'] = parsed_args.makeout
    arg_dict['clangbin'] = get_bin_path('clang')
    arg_dict['compiler_name'] = parsed_args.compiler_name          # compiler_name
