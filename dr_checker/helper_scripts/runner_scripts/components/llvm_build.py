...
class LLVMBuild(Component):
    ...
    def __init__(self, value_dict):
        ...
        if 'arch_num' in value_dict:
            arch_num = value_dict['arch_num']            # 32 or 64 bit
        ...
        self.gcc_name = compiler_name        # gcc_name
...
def _generate_llvm_bitcode(kernel_src_dir, base_output_folder, makeout_file, gcc_prefix, target_arch, clang_path,
                           command_output_dir=None):                    # gcc_prefix -> compiler_name
    ...
    for curr_line in makeout_lines: 
        curr_line = curr_line.strip()                   # remove the space of begin and end  read the output of make
